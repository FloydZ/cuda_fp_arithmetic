...
__global__ void add_fp(limb_t *out) {
    ...
    __fp_add224_32(c[0], c[1], c[2], c[3], c[4], c[5], c[6],
...
__global__ void sub_fp(limb_t *out) {
    ...
    __fp_sub224_32(c[0], c[1], c[2], c[3], c[4], c[5], c[6],
				  a[i][0], a[i][1], a[i][2], a[i][3], a[i][4], a[i][5], a[i][6],
				  b[i][0], b[i][1], b[i][2], b[i][3], b[i][4], b[i][5], b[i][6],
            	  __p[0], __p[1], __p[2], __p[3], __p[4], __p[5], __p[6]);
...
__global__ void schoolbookmul(limb_t *out) {
    ...
    __school32_7x7(c[0], c[1], c[2], c[3], c[4], c[5], c[6], c[7], c[8], c[9], c[10], c[11], c[12], c[13],
				  a[i][0], a[i][1], a[i][2], a[i][3], a[i][4], a[i][5], a[i][6],
				  b[i][0], b[i][1], b[i][2], b[i][3], b[i][4], b[i][5], b[i][6]);
...
__global__ void mul(limb_t *out) {
    ...
    __mul7x7_32(c[0], c[1], c[2], c[3], c[4], c[5], c[6], c[7], c[8], c[9], c[10], c[11], c[12], c[13],
				  a[i][0], a[i][1], a[i][2], a[i][3], a[i][4], a[i][5], a[i][6],
				  b[i][0], b[i][1], b[i][2], b[i][3], b[i][4], b[i][5], b[i][6]);
...
__global__ void schoolbookmullow(limb_t *out) {
    ...
    __school32_7x7_low(c[0], c[1], c[2], c[3], c[4], c[5], c[6],
				  	   a[i][0], a[i][1], a[i][2], a[i][3], a[i][4], a[i][5], a[i][6],
				  	   b[i][0], b[i][1], b[i][2], b[i][3], b[i][4], b[i][5], b[i][6]);
...
__global__ void mul_fp(limb_t *out) {
    ...
    __fp_mul7x7_32(c[0], c[1], c[2], c[3], c[4], c[5], c[6],
				  a[i][0], a[i][1], a[i][2], a[i][3], a[i][4], a[i][5], a[i][6], 
				  b[i][0], b[i][1], b[i][2], b[i][3], b[i][4], b[i][5], b[i][6],
...
void test_add_fp() {
    ...
    for (uint32_t i = 0; i < TESTS; i++) {
        if (compare(&c[i*LIMBS], add_fp_ok[i])) {
            printf("(%i) FAIL\n", i);
            printf("(%d) 0x%.8lX %.8lX %.8lX %.8lX %.8lX %.8lX %.8lX\n", i, c[i*LIMBS + 6], c[i*LIMBS + 5], c[i*LIMBS + 4], c[i*LIMBS + 3], c[i*LIMBS + 2], c[i*LIMBS + 1], c[i*LIMBS + 0]);
            printf("ok  0x%.8lX %.8lX %.8lX %.8lX %.8lX %.8lX %.8lX\n", add_fp_ok[i][6], add_fp_ok[i][5], add_fp_ok[i][4], add_fp_ok[i][3], add_fp_ok[i][2], add_fp_ok[i][1], add_fp_ok[i][0]);
            return;
        }
    }
    printf("OK\n");
...
void test_sub_fp() {
    ...
    for (uint32_t i = 0; i < TESTS; i++) {
        if (compare(&c[i*LIMBS], sub_fp_ok[i])) {
            printf("(%i) FAIL\n", i);
            printf("(%d) 0x%.8lX %.8lX %.8lX %.8lX %.8lX %.8lX %.8lX\n", i, c[i*LIMBS + 6], c[i*LIMBS + 5], c[i*LIMBS + 4], c[i*LIMBS + 3], c[i*LIMBS + 2], c[i*LIMBS + 1], c[i*LIMBS + 0]);
            printf("ok  0x%.8lX %.8lX %.8lX %.8lX %.8lX %.8lX %.8lX\n", sub_fp_ok[i][6], sub_fp_ok[i][5], sub_fp_ok[i][4], sub_fp_ok[i][3], sub_fp_ok[i][2], sub_fp_ok[i][1], sub_fp_ok[i][0]);
            return;
        }
    }
    printf("OK\n");
...
void test_mul() {
    ...
    for (uint32_t i = 0; i < TESTS; i++) {
        if (compare(&c[2*i*LIMBS], mul_ok[i], 2*LIMBS)) {
            printf("(%i) FAIL\n", i);
            printf("(%d) 0x%.8lX %.8lX %.8lX %.8lX %.8lX %.8lX %.8lX %.8lX %.8lX %.8lX %.8lX %.8lX %.8lX %.8lX\n", i, c[2*i*LIMBS + 13], c[2*i*LIMBS + 12] ,c[2*i*LIMBS + 11], c[2*i*LIMBS + 10] ,c[2*i*LIMBS + 9], c[2*i*LIMBS + 8], c[2*i*LIMBS + 7], c[2*i*LIMBS + 6], c[2*i*LIMBS + 5], c[2*i*LIMBS + 4], c[2*i*LIMBS + 3], c[2*i*LIMBS + 2], c[2*i*LIMBS + 1], c[2*i*LIMBS + 0]);
            printf("ok  0x%.8lX %.8lX %.8lX %.8lX %.8lX %.8lX %.8lX %.8lX %.8lX %.8lX %.8lX %.8lX %.8lX %.8lX\n", mul_ok[i][13], mul_ok[i][12], mul_ok[i][11], mul_ok[i][10], mul_ok[i][9], mul_ok[i][8],  mul_ok[i][7], mul_ok[i][6], mul_ok[i][5], mul_ok[i][4], mul_ok[i][3], mul_ok[i][2], mul_ok[i][1], mul_ok[i][0]);
            return;
        }
    }
    printf("OK\n");
...
void test_schoolbookmullow() {
    ...
    for (uint32_t i = 0; i < TESTS; i++) {
        if (compare(&c[i*LIMBS], mul_ok[i])) {
            printf("(%i) FAIL\n", i);
            printf("(%d) 0x%.8lX %.8lX %.8lX %.8lX %.8lX %.8lX %.8lX\n", i, c[i*LIMBS + 6], c[i*LIMBS + 5], c[i*LIMBS + 4], c[i*LIMBS + 3], c[i*LIMBS + 2], c[i*LIMBS + 1], c[i*LIMBS + 0]);
            printf("ok  0x%.8lX %.8lX %.8lX %.8lX %.8lX %.8lX %.8lX\n", mul_ok[i][6], mul_ok[i][5], mul_ok[i][4], mul_ok[i][3], mul_ok[i][2], mul_ok[i][1], mul_ok[i][0]);
            return;
        }
    }
    printf("OK\n");
...
void test_schoolbookmul() {
    ...
    for (uint32_t i = 0; i < TESTS; i++) {
        if (compare(&c[2*i*LIMBS], mul_ok[i], 2*LIMBS)) {
            printf("(%i) FAIL\n", i);
            printf("(%d) 0x%.8lX %.8lX %.8lX %.8lX %.8lX %.8lX %.8lX 0x%.8lX %.8lX %.8lX %.8lX %.8lX %.8lX %.8lX\n", i, c[2*i*LIMBS + 13], c[2*i*LIMBS + 12],c[2*i*LIMBS + 11], c[2*i*LIMBS + 10], c[2*i*LIMBS + 9], c[2*i*LIMBS + 8], c[2*i*LIMBS + 7], c[2*i*LIMBS + 6], c[2*i*LIMBS + 5], c[2*i*LIMBS + 4], c[2*i*LIMBS + 3], c[2*i*LIMBS + 2], c[2*i*LIMBS + 1], c[2*i*LIMBS + 0]);
            printf("ok  0x%.8lX %.8lX %.8lX %.8lX %.8lX %.8lX %.8lX 0x%.8lX %.8lX %.8lX %.8lX %.8lX %.8lX %.8lX\n", mul_ok[i][13], mul_ok[i][12], mul_ok[i][11], mul_ok[i][10], mul_ok[i][9], mul_ok[i][8], mul_ok[i][7], mul_ok[i][6], mul_ok[i][5], mul_ok[i][4], mul_ok[i][3], mul_ok[i][2], mul_ok[i][1], mul_ok[i][0]);
            return;
        }
    }
    printf("OK\n");
...
void test_mul_fp() {
    ...
    for (uint32_t i = 0; i < TESTS; i++) {
        if (compare(&c[i*LIMBS], mul_fp_ok[i])) {
            printf("(%i) FAIL\n", i);
            printf("(%d) 0x%.8lX %.8lX %.8lX %.8lX %.8lX %.8lX %.8lX\n", i, c[i*LIMBS + 6], c[i*LIMBS + 5], c[i*LIMBS + 4], c[i*LIMBS + 3], c[i*LIMBS + 2], c[i*LIMBS + 1], c[i*LIMBS + 0]);
            printf("ok  0x%.8lX %.8lX %.8lX %.8lX %.8lX %.8lX %.8lX\n", mul_fp_ok[i][6], mul_fp_ok[i][5], mul_fp_ok[i][4], mul_fp_ok[i][3], mul_fp_ok[i][2], mul_fp_ok[i][1], mul_fp_ok[i][0]);
            return;
        }
    }
    printf("OK\n");
